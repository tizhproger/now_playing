  ...
  function start_transfer(){
    ...
    let hostname = window.location.hostname;
        ...
        if (hostname === 'soundcloud.com') {
            ...
            if (title !== null) {
                send_message(JSON.stringify({cover, title, artists, status, progress, duration, album_url, album}));
            }
            ...
            if (title !== null) {
                send_message(JSON.stringify({ cover, title, artists, status, progress, duration, album }));
            }
            ...
            if (title !== null) {
                ...
                if (status !== 'stopped') {
                    send_message(JSON.stringify({ cover, title, artists, status, progress: Math.floor(progress), duration }));
                } else {
                    send_message(JSON.stringify({ status: 'stopped', title: '', artists: [], progress: 0, duration: 0}));
                }
            }
